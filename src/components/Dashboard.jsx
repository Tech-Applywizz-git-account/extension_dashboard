...
//                     <div style={{ padding: '2rem', textAlign: 'center', color: 'var(--text-muted)' }}>This tab is currently disabled.</div>
//                 ) : activeTab === 'Learned Patterns' ? (
//                     <LearnedPatterns searchQuery={searchQuery} dateRange={dateRange} customDates={customDates} />
//                 ) : activeTab === 'Analytics' ? (
//                     <AnalyticsTab searchQuery={searchQuery} dateRange={dateRange} customDates={customDates} />
